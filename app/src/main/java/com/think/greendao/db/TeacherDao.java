...
/** 
 * DAO for table "teacher_tb".
*/
public class TeacherDao extends AbstractDao<Teacher, Long> {

    public static final String TABLENAME = "teacher_tb";
    ...
    public static class Properties {
        ...
        public final static Property PictureId = new Property(2, Long.class, "pictureId", false, "PICTURE_ID");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"teacher_tb\" (" + //
                "\"_id\" INTEGER PRIMARY KEY ," + // 0: id
                "\"NAME\" TEXT," + // 1: name
                "\"PICTURE_ID\" INTEGER," + // 2: pictureId
                "\"AGE\" INTEGER NOT NULL );"); // 3: age
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"teacher_tb\"";
        db.execSQL(sql);
    }
    ...
    public Teacher readEntity(Cursor cursor, int offset) {
        Teacher entity = new Teacher( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getLong(offset + 2), // pictureId
    ...
    public void readEntity(Cursor cursor, Teacher entity, int offset) {
        ...
        entity.setPictureId(cursor.isNull(offset + 2) ? null : cursor.getLong(offset + 2));
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM teacher_tb T");
